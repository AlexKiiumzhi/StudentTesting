...
<html>
    ...
    <div class="w3-row-padding w3-margin-top">
        ...
        <form action="${pageContext.request.contextPath}/test/searchBySubject" method="get">
    ...
    <form action="${pageContext.request.contextPath}/test/all" method="get">
        <select name="sortBy">
            <c:choose>
                <c:when test="${localeCode == 'uk'}">
        ...
        <div class="w3-center w3-padding-32">
            <div class="w3-bar">
                <c:forEach begin="1" end="${testsWithSubjectDto.totalPages}" varStatus="loop">
                    <a href="${pageContext.request.contextPath}/test/all?pageNo=${loop.index - 1}" class="w3-bar-item w3-button w3-theme">${loop.index}</a>
                </c:forEach>
            </div>
        </div>
